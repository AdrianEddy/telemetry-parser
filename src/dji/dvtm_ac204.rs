...
pub struct FrameMeta {
    ...
    #[prost(message, optional, tag = "4")]
    pub gps_frame_meta: ::core::option::Option<FrameMetaOfGps>,
}
/// *
...
pub struct FrameMetaOfCamera {
    ...
    #[prost(message, optional, tag = "10")]
    pub accelerometer: ::core::option::Option<Accelerometer>,
}
/// *
/// Represents the frame metadata of GPS device.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct FrameMetaOfGps {
    #[prost(message, optional, tag = "2")]
    pub gps_basic: ::core::option::Option<GpsBasic>,
}
