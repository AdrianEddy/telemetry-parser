...
pub struct ImageProcessingQuality {
    /// * It is defined by XTRA, which indicates different image
...
pub mod fcm_data {
    ...
    impl ExitReason {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::XtraFcmOk => "XTRA_FCM_OK",
                Self::XtraFcmObstacleStuck => "XTRA_FCM_OBSTACLE_STUCK",
                Self::XtraFcmAborted => "XTRA_FCM_ABORTED",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "XTRA_FCM_OK" => Some(Self::XtraFcmOk),
                "XTRA_FCM_OBSTACLE_STUCK" => Some(Self::XtraFcmObstacleStuck),
                "XTRA_FCM_ABORTED" => Some(Self::XtraFcmAborted),
                _ => None,
            }
        }
    }
...
pub mod rc_mode {
    ...
    #[repr(i32)]
    pub enum RcModeEnum {
        XtraCommandModeManual = 0,
        XtraCommandModeAttiNormal = 3,
        XtraCommandModeGpsNormal = 7,
        XtraCommandModeGpsSport = 8,
        XtraCommandModeTripod = 12,
        XtraCommandModeFpv = 15,
    }
    impl RcModeEnum {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::XtraCommandModeManual => "XTRA_COMMAND_MODE_MANUAL",
                Self::XtraCommandModeAttiNormal => "XTRA_COMMAND_MODE_ATTI_NORMAL",
                Self::XtraCommandModeGpsNormal => "XTRA_COMMAND_MODE_GPS_NORMAL",
                Self::XtraCommandModeGpsSport => "XTRA_COMMAND_MODE_GPS_SPORT",
                Self::XtraCommandModeTripod => "XTRA_COMMAND_MODE_TRIPOD",
                Self::XtraCommandModeFpv => "XTRA_COMMAND_MODE_FPV",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "XTRA_COMMAND_MODE_MANUAL" => Some(Self::XtraCommandModeManual),
                "XTRA_COMMAND_MODE_ATTI_NORMAL" => Some(Self::XtraCommandModeAttiNormal),
                "XTRA_COMMAND_MODE_GPS_NORMAL" => Some(Self::XtraCommandModeGpsNormal),
                "XTRA_COMMAND_MODE_GPS_SPORT" => Some(Self::XtraCommandModeGpsSport),
                "XTRA_COMMAND_MODE_TRIPOD" => Some(Self::XtraCommandModeTripod),
                "XTRA_COMMAND_MODE_FPV" => Some(Self::XtraCommandModeFpv),
                _ => None,
            }
        }
    }
...
pub struct PanoDewarpParams {
    ...
    pub dive_case_slave: ::core::option::Option<DewarpParams>,
    #[prost(message, optional, tag = "6")]
    pub dive_case_master: ::core::option::Option<DewarpParams>,
}
#[derive(::serde::Serialize, Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct Magnifierstatus {
    /// magnifier status
    #[prost(enumeration = "magnifierstatus::Magnifierstate", tag = "1")]
    pub status: i32,
}
/// Nested message and enum types in `Magnifierstatus`.
pub mod magnifierstatus {
    #[derive(::serde::Serialize,
        Clone,
        Copy,
        Debug,
    ...
    #[repr(i32)]
    pub enum Magnifierstate {
        CameraMagnifierOff = 0,
        CameraMagnifierOn = 1,
    }
    impl Magnifierstate {
        /// String value of the enum field names used in the ProtoBuf definition.
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::CameraMagnifierOff => "CAMERA_MAGNIFIER_OFF",
                Self::CameraMagnifierOn => "CAMERA_MAGNIFIER_ON",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "CAMERA_MAGNIFIER_OFF" => Some(Self::CameraMagnifierOff),
                "CAMERA_MAGNIFIER_ON" => Some(Self::CameraMagnifierOn),
                _ => None,
            }
        }
    }
...
pub struct ClipMeta {
    ...
    pub magnifier_status: ::core::option::Option<Magnifierstatus>,
}
/// *
...
pub struct FrameMeta {
    ...
    #[prost(message, optional, tag = "4")]
    pub bluetooth_rc_frame_meta: ::core::option::Option<FrameMetaOfBluetoothRc>,
}
/// *
...
#[derive(::serde::Serialize, Clone, PartialEq, ::prost::Message)]
pub struct FrameMetaOfBluetoothRc {
    #[prost(message, optional, tag = "1")]
    pub bluetooth_rc_dev_header: ::core::option::Option<MetaHeaderOfDevice>,
    /// * Represent the bluetooth remote control gps basic information.
    #[prost(message, optional, tag = "2")]
    pub gps_basic: ::core::option::Option<GpsBasic>,
    /// * Represent the bluetooth remote control body velocity in NED coordinate system,
